...
export default function PostForm({navigation, route}: any) {
  ...
  function Submitform() {
    if (obj.id === 0) {
      ...
      //Edit
      axios
        .put('https://jsonplaceholder.typicode.com/posts', obj)
        .then(result => {
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <View style={{marginBottom: 20}}>
          <Text style={{fontSize: 25, color: 'black', marginBottom: 10}}>
            UserName:
          </Text>
          <View
            style={{
        ...
        <View style={{marginBottom: 20}}>
          ...
          <TextInput
            onChangeText={text => setobj({...obj, body: text})}
            multiline={true}
            value={obj.body}
